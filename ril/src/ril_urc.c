...
// GPS URC callback
extern void OnURCHandler_GNSSCMD(const char * strURC,void * reserved);
extern void OnURCHandler_GNSSAGPS(const char * strURC,void * reserved);
...
const static ST_URC_HDLENTRY m_AtURCHdlEntry[] = {
	...
	{"\r\n+QGNSSCMD:",							  OnURCHandler_GNSSCMD},
	{"\r\n+QGAGPS:",							  OnURCHandler_GNSSAGPS},
