...
#define RIL_AUDIO_DEBUG_ENABLE 0
#if RIL_AUDIO_DEBUG_ENABLE > 0
#define RIL_AUDIO_DEBUG_PORT  UART_PORT1
static char DBG_Buffer[100];
#define RIL_AUDIO_DEBUG(BUF,...)  QL_TRACE_LOG(RIL_AUDIO_DEBUG_PORT,BUF,100,__VA_ARGS__)
#else
#define RIL_AUDIO_DEBUG(BUF,...) 
#endif
...
s32 RIL_AUD_PlayFile(char* filePath, bool isRepeated)
{
    ...
    RIL_AUDIO_DEBUG(DBG_Buffer,"<--RIL_AUD_PlayFile=%d.%d.%d.%d-->\r\n",ret,repeat,vol_level,channel);
