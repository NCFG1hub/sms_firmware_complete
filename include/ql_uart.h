...
/*****************************************************************
* Function:     Ql_UART_TxDoneRegister 
* 
* Description:
*               Register a GPIO for pulling down when TX transmission is complete. Used for 485 communication.
*               Special reminder:Before using this API, you must initialize the PIN by Ql_GPIO_Init.
*
* Parameters:
*               pinName:
*               [in]        GPIO that needs to be controlled.
* Return:        
*               QL_RET_OK, Successful operation
*               QL_RET_ERR_PARAM, fail to operate,generally this IO does not exist.
*****************************************************************/
s32 Ql_UART_TxDoneRegister(Enum_PinName pinName);
